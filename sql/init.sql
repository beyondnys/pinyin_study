...
CREATE TABLE IF NOT EXISTS word_libraries (
  ...
  pinyin VARCHAR(64) NOT NULL COMMENT '主读音（声调符号）',
  pinyin_list VARCHAR(512) NOT NULL DEFAULT '[]' COMMENT '全部读音 JSON，含多音字',
...
CREATE TABLE IF NOT EXISTS practice_questions (
  ...
  hanzi VARCHAR(16) NOT NULL,
  pinyin VARCHAR(64) NOT NULL COMMENT '主读音（声调符号）',
  pinyin_list VARCHAR(512) NOT NULL DEFAULT '[]' COMMENT '全部合法读音 JSON',
